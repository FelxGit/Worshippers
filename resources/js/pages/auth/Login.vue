...
export default {
  ...
  methods: {
    ...
    loginWithGoogle() {
      ...
      let win = window.open('/api/auth/google', "SignIn", "width=780,height=410,toolbar=0,scrollbars=0,status=0,resizable=0,location=0,menuBar=0,top=" + topPosition + ",left=" + leftPosition);
